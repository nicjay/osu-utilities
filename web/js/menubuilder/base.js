...
(function($) {
	...
	$.widget("mjs.nestedSortable", $.extend({}, $.ui.sortable.prototype, {
		...
		toArray: function(options) {
			...
			if (!o.excludeRoot) {
				...
				ret.push({
					...
					"title" : $(o.items, this.element).attr("data-title"),
					"link"  : $(o.items, this.element).attr("data-link"),
					"target": ($(o.items, this.element).attr("data-target") != undefined) ? $('li', this.element).attr("data-target") : 0 ,
					"active": ($(o.items, this.element).attr("data-active") != undefined) ? $('li', this.element).attr("data-active") : 0 ,					
				});
				left++;
			}
        ...
        var target = ($(item).attr("data-target") != undefined) ? $(item).attr("data-target") : 0;
        var active = ($(item).attr("data-active") != undefined) ? $(item).attr("data-active") : 0;
				...
				if (id) {
					ret.push({"item_id": id[2], "parent_id": pid, "depth": depth, "left": left, "right": right, "title" : title, "link" : link, "target" : target, "active" : active});						
				}
