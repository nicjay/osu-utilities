...
function Keypad() {
	...
	this.addKeyDef('CLEAR', 'clear', function(inst) { this.form.submit(); });
	...
	this._defaults = { // Global defaults for all the keypad instances
		...
		showAnim: false, // Name of jQuery animation for popup
		...
		layout: ['123' + this.CLOSE, '456' + this.CLEAR, '789' + this.ENTER, this.SPACE + '0'], // Layout of keys
