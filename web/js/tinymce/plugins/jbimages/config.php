...
| -------------------------------------------------------------------*/
	...
	$config['img_path'] = '/robechar/portal/img/upload'; // Relative to domain name
	$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'] . '\robechar\portal\app\webroot\img\upload'; // Physical path. 
//print_r($config);
/*-------------------------------------------------------------------
| 
